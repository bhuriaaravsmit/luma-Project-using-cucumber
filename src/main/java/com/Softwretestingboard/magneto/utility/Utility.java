package com.Softwretestingboard.magneto.utility;

import com.Softwretestingboard.magneto.browserfactory.ManageBrowser;
...
//*************************** Select Class Methods ***************************************//
    ...
    public void verifyText(WebElement element,String expectedMessage){
        String actualTxt = element.getText();
        System.out.println(actualTxt);
        Assert.assertEquals( expectedMessage, actualTxt);
    }

    public void verifyText(By element,String expectedMessage){
        String actualTxt = driver.findElement(element).getText();
        System.out.println(actualTxt);
        Assert.assertEquals( expectedMessage, actualTxt);
    }
